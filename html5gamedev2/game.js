class Game {
    constructor() {
        ...
        this.sprites = [];
        this.states = {
            static: { frames: [0], loop: true, motion: {x: 0, y: 0}, fps: 1 },
            walk: { frames: [0,1,2,3,4,5,6,7], loop: true, motion: { x: 120, y: 0 }, fps: 12 },
            turn: { "frames": [8,9,10,11,12,13,14], loop: false, motion: { x: 0, y: 0 },
                    oncomplete: {
                        state: "walk", flip: true, move: { x: 40, y: 0 } }, userinteraction: false, fps: 12},
            fall: { frames: [23,24,25,26,27], loop: false, motion: { x: 0, y: 0 },
                    oncomplete: {
                          state: "static", flip: true}, userinteraction: false, fps: 12},
            pour: { frames: [35,36,37,38,39,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,39,38,37,36,35], loop: false, motion: { x: 0, y: 0 }, 
                   oncomplete: { state: "static", flip: false }, userinteraction: false, fps: 12 }
        };
    ...
    tap(evt) {
        ...
        if(this.bucket.state.userinteraction != null && !this.bucket.state.userinteraction) {
            return;
        }
    ...
    update(dt) {
        ...
        if(this.currentTime > this.state.duration) {
            if(this.state.loop) {
                ...
                if(this.state.oncomplete.flip != null) {
                    this.flipped = (this.state.oncomplete.flip) ? !this.flipped : this.flipped;
