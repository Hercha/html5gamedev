class Game {
    ...
    init() {
        ...
        bodies.push(Bodies.rectangle(50, 150, 100, 10, {isStatic: true, label:"clickable"})); // Bucket plattform
        bodies.push(Bodies.rectangle(-30, 300, 60, 600, {isStatic: true})); // Left side
        bodies.push(Bodies.rectangle(400, 300, 400, 10, {isStatic: true, angle: 0.4, label:"clickable"})); // Sloping plattform
