class Game {
    ...
    init() {
        ...
        bodies.push(Bodies.rectangle(400, 610, 810, 60, {isStatic: true, label: "floor", collisonFilter: {defaultCategory} })); // Floor
        bodies.push(Bodies.rectangle(120, 150, 240, 10, {collisionFilter: {category: defaultCategory} }));
        bodies.push(Bodies.rectangle(20, 175, 40, 40, {isStatic: true, label:"clickable", collisionFilter: {category: defaultCategory} })); // supports right end of bucket plattform
        bodies.push(Bodies.rectangle(170, 175, 40, 40, {isStatic: true, label: "clickable", collisionFilter: {defaultCategory} })); // supports right end of bucket platform
    ...
    render () {
        ...
        if(this.debug) {
            this.debugPhysics(bodies, constraints);
        }
    }
